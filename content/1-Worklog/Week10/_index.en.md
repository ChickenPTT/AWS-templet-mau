...
- Study labs from the Data and Analytics group on AWS Cloud Journey.
- Master fundamental knowledge about collecting, storing, processing, and analyzing data on AWS.
- Connect data analytics knowledge with the need for reporting defective product data in the proposal.
- Add ideas to improve dashboards, statistics, and data querying for the project.
...
- Gained understanding of data design principles for AWS systems:
  <br> + Collect data from applications
  <br> + Store structured and unstructured data
  <br> + Query processing history
  <br> + Analyze operational metrics

- Connected with project:
  <br> + Store image analysis results in DynamoDB
  <br> + Save proof images in S3
  <br> + Monitor processing quantity and errors using CloudWatch
  <br> + Prepare data for dashboards/reporting
