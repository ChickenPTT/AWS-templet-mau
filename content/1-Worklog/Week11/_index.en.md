...
- Review the entire proposal, workshop, and worklog written so far.
- Add missing content related to operations, security, and cost optimization.
- Verify consistency between architecture, practice content, and reports.
- Prepare final versions for presentation/evaluation.
...
- Reviewed main content of proposal and workshop.
- Added key points about:
  <br> + IAM permissions
...
- Standardized worklog format across weeks.
- Ensured that report content has clear connections between the problem, architecture, and practice sections.
