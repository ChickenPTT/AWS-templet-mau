...
![Tìm Amazon SQS](/images/5-Workshop/5.3-S3-vpc/image13.png)
...
![Chọn Standard Queue](/images/5-Workshop/5.3-S3-vpc/image14.png)

3. Đặt tên queue là **image-processing-queue**.

![Đặt tên SQS queue](/images/5-Workshop/5.3-S3-vpc/image15.png)

4. Cấu hình các thông số quan trọng cho queue.

![Cấu hình thông số SQS](/images/5-Workshop/5.3-S3-vpc/image16.png)

![Kiểm tra cấu hình SQS](/images/5-Workshop/5.3-S3-vpc/image17.png)
...
![Copy ARN của SQS queue](/images/5-Workshop/5.3-S3-vpc/image18.png)
