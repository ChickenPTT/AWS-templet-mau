...
![Create S3 bucket](/images/5-Workshop/5.4-S3-onprem/image19.png)

2. Name the bucket using the format **logistics-raw-images-&lt;your-name&gt;**.

The bucket name must be globally unique across AWS.

![Name the S3 bucket](/images/5-Workshop/5.4-S3-onprem/image20.png)

3. Select the **ap-southeast-1 (Singapore)** Region because it is close to Vietnam.

![Select Singapore Region](/images/5-Workshop/5.4-S3-onprem/image21.png)

4. Keep the default settings, then choose **Create bucket**.

![Keep default settings](/images/5-Workshop/5.4-S3-onprem/image22.png)

![Bucket created successfully](/images/5-Workshop/5.4-S3-onprem/image23.png)
...
![Open SQS access policy](/images/5-Workshop/5.4-S3-onprem/image24.png)
...
![Add policy allowing S3 to send messages to SQS](/images/5-Workshop/5.4-S3-onprem/image25.png)
...
![Open Event notifications](/images/5-Workshop/5.4-S3-onprem/image26.png)

![Create event notification](/images/5-Workshop/5.4-S3-onprem/image27.png)

2. Name the event **new-image-uploaded**.

![Name the event notification](/images/5-Workshop/5.4-S3-onprem/image28.png)

3. In **Event types**, select **s3:ObjectCreated:***.

![Select ObjectCreated event type](/images/5-Workshop/5.4-S3-onprem/image29.png)
...
![Configure image file suffix](/images/5-Workshop/5.4-S3-onprem/image30.png)

5. In **Destination**, choose **SQS Queue**, then select **image-processing-queue**.

![Select SQS queue as destination](/images/5-Workshop/5.4-S3-onprem/image31.png)

6. Choose **Save changes** to save the configuration.

![Save event notification](/images/5-Workshop/5.4-S3-onprem/image32.png)
