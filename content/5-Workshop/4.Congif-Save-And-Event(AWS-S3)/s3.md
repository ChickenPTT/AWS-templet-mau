...
![Tạo S3 bucket](/images/5-Workshop/5.4-S3-onprem/image19.png)

2. Đặt tên bucket theo định dạng **logistics-raw-images-&lt;tên-bạn&gt;**.

Tên bucket phải là duy nhất trên toàn bộ AWS.

![Đặt tên S3 bucket](/images/5-Workshop/5.4-S3-onprem/image20.png)

3. Chọn Region **ap-southeast-1 (Singapore)** để gần Việt Nam.

![Chọn Region Singapore](/images/5-Workshop/5.4-S3-onprem/image21.png)

4. Giữ nguyên các cài đặt mặc định, sau đó chọn **Create bucket**.

![Giữ cài đặt mặc định](/images/5-Workshop/5.4-S3-onprem/image22.png)

![Tạo bucket thành công](/images/5-Workshop/5.4-S3-onprem/image23.png)
...
![Mở Access policy của SQS](/images/5-Workshop/5.4-S3-onprem/image24.png)
...
![Thêm policy cho S3 gửi message vào SQS](/images/5-Workshop/5.4-S3-onprem/image25.png)
...
![Mở Event notifications](/images/5-Workshop/5.4-S3-onprem/image26.png)

![Create event notification](/images/5-Workshop/5.4-S3-onprem/image27.png)

2. Đặt tên event là **new-image-uploaded**.

![Đặt tên event notification](/images/5-Workshop/5.4-S3-onprem/image28.png)

3. Ở phần **Event types**, tích chọn **s3:ObjectCreated:***.

![Chọn event type ObjectCreated](/images/5-Workshop/5.4-S3-onprem/image29.png)
...
![Cấu hình suffix file ảnh](/images/5-Workshop/5.4-S3-onprem/image30.png)

5. Ở phần **Destination**, chọn **SQS Queue**, sau đó chọn queue **image-processing-queue**.

![Chọn SQS queue làm destination](/images/5-Workshop/5.4-S3-onprem/image31.png)

6. Chọn **Save changes** để lưu cấu hình.

![Lưu event notification](/images/5-Workshop/5.4-S3-onprem/image32.png)
