...
![Truy cập AWS Lambda](/images/5-Workshop/5.5-Policy/image1.png)

2. Chọn **Author from scratch**.

![Chọn Author from scratch](/images/5-Workshop/5.5-Policy/image2.png)

![Tạo Lambda function](/images/5-Workshop/5.5-Policy/image3.png)

3. Cấu hình Lambda Function.

![Cấu hình Lambda function](/images/5-Workshop/5.5-Policy/image4.png)

![Chọn runtime và role](/images/5-Workshop/5.5-Policy/image5.png)
...
![Mở General configuration](/images/5-Workshop/5.5-Policy/image7.png)

6. Đặt **Timeout = 60 giây**, sau đó lưu cấu hình.

![Đặt timeout cho Lambda](/images/5-Workshop/5.5-Policy/image8.png)
...
![Add trigger cho Lambda](/images/5-Workshop/5.5-Policy/image9.png)

2. Chọn source là **SQS**.

![Chọn SQS trigger](/images/5-Workshop/5.5-Policy/image10.png)
...
![Cấu hình SQS trigger](/images/5-Workshop/5.5-Policy/image11.png)
...
![Viết code Lambda và Deploy](/images/5-Workshop/5.5-Policy/image12.png)
