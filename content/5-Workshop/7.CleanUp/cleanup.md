...
![Xóa SQS queue](/images/5-Workshop/5.7-CleanUp/image1.png)

3. Nhập **Confirm** để xác nhận xóa queue.

![Xác nhận xóa SQS queue](/images/5-Workshop/5.7-CleanUp/image2.png)
...
![Xóa Lambda function](/images/5-Workshop/5.7-CleanUp/image3.png)

3. Nhập xác nhận để xóa function.

![Xác nhận xóa Lambda function](/images/5-Workshop/5.7-CleanUp/image4.png)
...
![Xóa S3 bucket](/images/5-Workshop/5.7-CleanUp/image5.png)
...
![Xóa IAM Role](/images/5-Workshop/5.7-CleanUp/image6.png)
